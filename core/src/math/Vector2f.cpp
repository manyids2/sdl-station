...
Vector2f &Vector2f::lerp(const Vector2f &_start, const Vector2f &_end,
...
const Vector2f Vector2f::parseString(const std::string &_input) {
  ...
  if (divider != std::string::npos) {
    ...
    return Vector2f(Utils::String::toFloat(first),
                    Utils::String::toFloat(second));
  }

  return Vector2f(Utils::String::toFloat(_input),
                  Utils::String::toFloat(_input));
}
