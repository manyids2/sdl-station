...
public:
  ...
  // config storage
  static std::string &getSystemConfFilePath() {
    return getInstance()->mSystemConfFilePath;
  }
  ...
  static std::string &getScreenShotPath() {
    return getInstance()->mScreenShotsPath;
  }
  ...
  static std::string &getUserMusicPath() {
    return getInstance()->mUserMusicPath;
  }

  // Themes
  static std::string &getThemesPath() { return getInstance()->mThemesPath; }
  static std::string &getUserThemesPath() {
    return getInstance()->mUserThemesPath;
  }

  // Keyboard mappings
  static std::string &getKeyboardMappingsPath() {
    return getInstance()->mKeyboardMappingsPath;
  }
  static std::string &getUserKeyboardMappingsPath() {
    return getInstance()->mUserKeyboardMappingsPath;
  }

  // Decorations
  static std::string &getDecorationsPath() {
    return getInstance()->mDecorationsPath;
  }
  static std::string &getUserDecorationsPath() {
    return getInstance()->mUserDecorationsPath;
  }

  // Shaders
  static std::string &getShadersPath() { return getInstance()->mShadersPath; }
  static std::string &getUserShadersPath() {
    return getInstance()->mUserShadersPath;
  }

  // Video Filters
  static std::string &getVideoFilters() {
    return getInstance()->mVideoFiltersPath;
  }
  static std::string &getUserVideoFilters() {
    return getInstance()->mUserVideoFiltersPath;
  }

  // Retroachivement sounds
  static std::string &getRetroachivementSounds() {
    return getInstance()->mRetroachivementSounds;
  }
  static std::string &getUserRetroachivementSounds() {
    return getInstance()->mUserRetroachivementSounds;
  }

  // Emulationstation
  static std::string &getEmulationStationPath() {
    return getInstance()->mEmulationStationPath;
  }
  static std::string &getUserEmulationStationPath() {
    return getInstance()->mUserEmulationStationPath;
  }

  static std::string &getTimeZonesPath() {
    return getInstance()->mTimeZonesPath;
  }

  static std::string &getVersionInfoPath() {
    return getInstance()->mVersionInfoPath;
  }
  static std::string &getUserManualPath() {
    return getInstance()->mUserManualPath;
  }
