...
bool initializeGlExtensions() {
  ...
  glCreateProgram =
      (PFNGLCREATEPROGRAMOBJECTARBPROC)_glProcAddress("glCreateProgram");
  ...
  glGetShaderInfoLog =
      (PFNGLGETSHADERINFOLOGPROC)_glProcAddress("glGetShaderInfoLog");
  ...
  glGetProgramInfoLog =
      (PFNGLGETPROGRAMINFOLOGPROC)_glProcAddress("glGetProgramInfoLog");
  ...
  glGetUniformLocation =
      (PFNGLGETUNIFORMLOCATIONPROC)_glProcAddress("glGetUniformLocation");
  glGetAttribLocation =
      (PFNGLGETATTRIBLOCATIONPROC)_glProcAddress("glGetAttribLocation");
  glBufferData = (PFNGLBUFFERDATAPROC)_glProcAddress("glBufferData");
  glBufferSubData =
      (PFNGLBUFFERSUBDATAARBPROC)_glProcAddress("glBufferSubData");
  glVertexAttribPointer =
      (PFNGLVERTEXATTRIBPOINTERPROC)_glProcAddress("glVertexAttribPointer");
  glEnableVertexAttribArray = (PFNGLENABLEVERTEXATTRIBARRAYPROC)_glProcAddress(
      "glEnableVertexAttribArray");
  glDisableVertexAttribArray =
      (PFNGLDISABLEVERTEXATTRIBARRAYPROC)_glProcAddress(
          "glDisableVertexAttribArray");
  glUniformMatrix4fv =
      (PFNGLUNIFORMMATRIX4FVPROC)_glProcAddress("glUniformMatrix4fv");
  ...
  glFramebufferTexture2D =
      (PFNGLFRAMEBUFFERTEXTURE2DPROC)_glProcAddress("glFramebufferTexture2D");
  glBindFramebuffer =
      (PFNGLBINDFRAMEBUFFEREXTPROC)_glProcAddress("glBindFramebuffer");
  glBlitFramebuffer =
      (PFNGLBLITFRAMEBUFFERPROC)_glProcAddress("glBlitFramebuffer");
  glGenFramebuffers =
      (PFNGLGENFRAMEBUFFERSPROC)_glProcAddress("glGenFramebuffers");
  glDeleteFramebuffers =
      (PFNGLDELETEFRAMEBUFFERSPROC)_glProcAddress("glDeleteFramebuffers");

  glGetActiveUniform =
      (PFNGLGETACTIVEUNIFORMPROC)_glProcAddress("glGetActiveUniform");

  return glCreateShader != nullptr && glCompileShader != nullptr &&
         glCreateProgram != nullptr && glGenBuffers != nullptr &&
         glBindBuffer != nullptr && glGetShaderiv != nullptr &&
         glGetShaderInfoLog != nullptr && glAttachShader != nullptr &&
         glLinkProgram != nullptr && glGetProgramiv != nullptr &&
         glGetProgramInfoLog != nullptr && glUseProgram != nullptr &&
         glUniform1i != nullptr && glGetUniformLocation != nullptr &&
         glGetAttribLocation != nullptr && glBufferData != nullptr &&
         glVertexAttribPointer != nullptr && glBufferData != nullptr &&
         glBufferSubData != nullptr && glVertexAttribPointer != nullptr &&
         glEnableVertexAttribArray != nullptr &&
         glDisableVertexAttribArray != nullptr &&
         glUniformMatrix4fv != nullptr && glActiveTexture_ != nullptr &&
         glUniform1f != nullptr && glUniform2f != nullptr &&
         glDeleteShader != nullptr && glDeleteProgram != nullptr;
}
} // namespace glext
#endif
...
bool _GLCheckError(const char *_funcName) {
  ...
  if (errorCode != GL_NO_ERROR) {
    LOG(LogError) << "GL error: " << _funcName
