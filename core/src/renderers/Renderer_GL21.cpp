...
std::string OpenGL21Renderer::getDriverName() { return "OPENGL 2.1"; }

std::vector<std::pair<std::string, std::string>>
OpenGL21Renderer::getDriverInformation() {
...
unsigned int
OpenGL21Renderer::createTexture(const Texture::Type _type, const bool _linear,
...
void OpenGL21Renderer::updateTexture(const unsigned int _texture,
  ...
  if (_x == -1 && _y == -1) {
    ...
    glTexSubImage2D(GL_TEXTURE_2D, 0, _x, _y, _width, _height,
                    convertTextureType(_type), GL_UNSIGNED_BYTE, _data);
...
void OpenGL21Renderer::drawLines(const Vertex *_vertices,
                                 const unsigned int _numVertices,
                                 const Blend::Factor _srcBlendFactor,
                                 const Blend::Factor _dstBlendFactor) {
  glEnable(GL_BLEND);
  glBlendFunc(convertBlendFactor(_srcBlendFactor),
...
void OpenGL21Renderer::drawTriangleStrips(const Vertex *_vertices,
                                          const unsigned int _numVertices,
                                          const Blend::Factor _srcBlendFactor,
                                          const Blend::Factor _dstBlendFactor,
...
void OpenGL21Renderer::setViewport(const Rect &_viewport) {
  ...
  glViewport(_viewport.x, getWindowHeight() - _viewport.y - _viewport.h,
...
void OpenGL21Renderer::setScissor(const Rect &_scissor) {
  if ((_scissor.x == 0) && (_scissor.y == 0) && (_scissor.w == 0) &&
    ...
    glScissor(_scissor.x, getWindowHeight() - _scissor.y - _scissor.h,
...
void OpenGL21Renderer::drawTriangleFan(const Vertex *_vertices,
                                       const unsigned int _numVertices,
                                       const Blend::Factor _srcBlendFactor,
                                       const Blend::Factor _dstBlendFactor) {
...
void OpenGL21Renderer::drawSolidRectangle(const float _x, const float _y,
...
void OpenGL21Renderer::setStencil(const Vertex *_vertices,
                                  const unsigned int _numVertices) {
...
void OpenGL21Renderer::disableStencil() { glDisable(GL_STENCIL_TEST); }
