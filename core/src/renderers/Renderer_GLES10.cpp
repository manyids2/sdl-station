...
std::string GLES10Renderer::getDriverName() { return "OPENGL ES 1.0"; }

std::vector<std::pair<std::string, std::string>>
GLES10Renderer::getDriverInformation() {
  std::vector<std::pair<std::string, std::string>> info;

  info.push_back(
      std::pair<std::string, std::string>("GRAPHICS API", "OPENGL ES 1.0"));
...
unsigned int
GLES10Renderer::createTexture(const Texture::Type _type, const bool _linear,
...
void GLES10Renderer::updateTexture(const unsigned int _texture,
...
void GLES10Renderer::drawLines(const Vertex *_vertices,
...
void GLES10Renderer::drawTriangleStrips(const Vertex *_vertices,
                                        const unsigned int _numVertices,
                                        const Blend::Factor _srcBlendFactor,
                                        const Blend::Factor _dstBlendFactor,
...
void GLES10Renderer::drawSolidRectangle(const float _x, const float _y,
...
void GLES10Renderer::drawTriangleFan(const Vertex *_vertices,
                                     const unsigned int _numVertices,
                                     const Blend::Factor _srcBlendFactor,
                                     const Blend::Factor _dstBlendFactor) {
  glEnable(GL_BLEND);
...
void GLES10Renderer::setStencil(const Vertex *_vertices,
                                const unsigned int _numVertices) {
...
void GLES10Renderer::disableStencil() { glDisable(GL_STENCIL_TEST); }
} // namespace Renderer
